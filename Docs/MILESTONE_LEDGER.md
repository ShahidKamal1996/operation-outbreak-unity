...
| **1P.5** | **Toon Soldier visual integration** | **VERIFIED** | 2026-08-16 → owner QA 2026-08-17 | commits on `arena/milestone-1p5-toon-soldier-integration` — presentation-only swap with 12 QA fixes (controller rebuild tool, grounding −1, presentation aim, hand-cluster muzzle measurement, follow-muzzle architecture, layered shooting with upper-body mask); EditMode 137/137; generated assets committed at `5f14ebb` |
